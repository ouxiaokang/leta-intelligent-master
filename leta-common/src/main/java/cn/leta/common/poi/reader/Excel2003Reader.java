...
/**
 * 抽象Exceel 2003读取器。过实现HSSFListener监听器，采用事件驱动模式解析excel 2003。遇到特定事件才会触发，大大降低内存使用
...
//    private POIFSFileSystem poifsFileSystem;
    ...
    public void processRecord(Record record) {
        ...
        String thisStr = null;
        String value = null;
        List boundSheetRecords = new ArrayList<>();
        switch (record.getSid()) {
            ...
            case BOFRecord.sid:
                ...
                if (br.getType() == BOFRecord.TYPE_WORKSHEET) {
                    // 如果有需要，则建立子工作薄
                    if (workbookBuildingListener != null && hssfWorkbook == null) {
                        hssfWorkbook = workbookBuildingListener.getStubHSSFWorkbook();
                    }
...
//                    sheetName = orderedBSRs[sheetIndex].getSheetname();
            ...
            case FormulaRecord.sid: //单元格为公式类型
                ...
                if (outputFormulaValues) {
                    ...
                    thisStr = HSSFFormulaParser.toFormulaString(hssfWorkbook,
