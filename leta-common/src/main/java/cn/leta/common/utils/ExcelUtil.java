...
import cn.leta.common.poi.reader.Excel2003Reader;
import cn.leta.common.poi.reader.Excel2007Reader;
import cn.leta.common.poi.reader.ExcelReader;
import cn.leta.common.poi.reader.IRowReader;
import cn.leta.common.poi.writer.ExcelWriter;
import cn.leta.common.poi.writer.IRowWriter;
...
public final class ExcelUtil {
    ...
    public static <T> void writeExcel(String fileName, IRowWriter<T> rowWriter, List<String> headers, Map<String, List<T>> sheetDataMap) throws Exception {
        new ExcelWriter<>(rowWriter, headers, sheetDataMap, fileName).process();
    }
    /**
     * 不带表头写入
     * @param fileName
    ...
    public static <T> void writeExcel(String fileName, IRowWriter<T> rowWriter, Map<String, List<T>> sheetDataMap) throws Exception {
        new ExcelWriter<>(rowWriter, sheetDataMap, fileName).process();
    }
