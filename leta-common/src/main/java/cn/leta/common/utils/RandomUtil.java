...
public final class RandomUtil {
    ...
    public static double randomDouble(double min, double max, int scale, RoundingMode roundingMode) {
        return BigDecimal.valueOf(randomDouble(min, max)).setScale(scale, roundingMode).doubleValue();
    }
    ...
    public static double randomDouble(int scale, RoundingMode roundingMode) {
        return BigDecimal.valueOf(randomDouble()).setScale(scale, roundingMode).doubleValue();
    }
    ...
    public static double randomDouble(double limit, int scale, RoundingMode roundingMode) {
        return BigDecimal.valueOf(randomDouble(limit)).setScale(scale, roundingMode).doubleValue();
    }
